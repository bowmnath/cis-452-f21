...
|  9   | Memory management<br> ([Memory intro slides](slides/memory-intro.pdf))<br> ([Virtual addresses slides](slides/memory-addresses.pdf))<br> ([Linking and Loading slides](slides/memory-loading-linking.pdf))<br> ([Swapping slides](slides/memory-swapping.pdf)) <br> ([Contiguous allocation slides](slides/memory-contiguous.pdf))<br> ([Fragmentation slides](slides/memory-fragmentation.pdf))  | 7.1 - 7.3<br>[PL-check exam](https://www.prairielearn.org/pl/course_instance/128860/assessment/2314608)<br>[PL-check exam (timed)](https://www.prairielearn.org/pl/course_instance/128860/assessment/2314607) | **Wednesday 10/27** [Lab 8](https://www.prairielearn.org/pl/course_instance/128860/assessment/2314509) due<br>**Midterm Exam** **Thursday October 28 (during lab)** |
