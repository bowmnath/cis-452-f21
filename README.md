...
|  12  | Frame allocation<br> ([slides](slides/virtual-frame-allocation.pdf))<br> Thrashing<br> ([Thrashing slides](slides/virtual-thrashing.pdf))<br>([Thrashing Avoidance slides](slides/virtual-models.pdf))<br>Memory mapping<br> ([slides](slides/virtual-mmap-files.pdf)) | 8.5 - 8.10 | **Wednesday 11/17** Lab 10 due<br> |
